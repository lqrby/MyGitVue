...
if __name__ == '__main__':
    filename = "E:/myTestFile/TestObject/TongChuangYuanMa/yunqianbao/static/shenfenzheng_1.txt"
    filename2 = "E:/myTestFile/TestObject/TongChuangYuanMa/yunqianbao/static/shenfenzheng.txt"
